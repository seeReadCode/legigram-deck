...
Chris Reed [@seereadnow](https:///twitter.com/seereadnow), [Super Basic](https://www.superbasic.xyz) – 2023.01.12 – [Google Developers Group Dallas](https://gdg.community.dev/events/details/google-gdg-dallas-presents-legigram-rethinking-civic-tech/)
...
#### <!--fit--> ⬆️ Understanding of legislative process <br/> ⬆️ Civic engagement and oversight <br/> ⬆️ Better press and better government
...
#### <!--fit--> Next.js: "Meta" Framework <br> Tailwind: CSS / UI <br> Cloudflare: Content Delivery Network 🚨 <br> Heroku: DevOps and Hosting 🚨<br>Redis: Memory Store<br>Legistar API: Data
...
#### <!--fit--> Google Drive: Planning spreadsheet<br> Github: Code Repo and Issues<br>Email & Twitter: Outreach and Growth 🚨<br>Funding: Ko-fi ➡️ Patreon<br> Catch-all directory<br>Changelog
...
### <!-- fit --> 📢 Check out<br> Full Stack DFW
...
#### <!--fit--> 👉 Learn more at [fullstackdfw.com](https://www.fullstackdfw.com)
